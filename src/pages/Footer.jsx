  ...
  return (
    <div className="flex flex-col items-center pt-10 md:pt-20 pb-10 space-y-6">
      <div className="flex md:hidden space-x-10 items-center">
        <a href="https://www.instagram.com/turkifaisal0/" target="_blank">
          <svg
            className="w-[45px] h-[45px] hover:scale-110 transition duration-300 ease-in-out cursor-pointer"
            fill="none"
            viewBox="0 0 256 256"
            id="Flat"
        ...
        <a href="https://www.linkedin.com/in/turki-almutairi-7bb768231" target="_blank">
          <svg
            viewBox="0 0 192 192"
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
          ...
          <a href="https://github.com/lltrx" target="_blank">
        <svg
          viewBox="0 0 48 48"
          id="Layer_2"
          data-name="Layer 2"
