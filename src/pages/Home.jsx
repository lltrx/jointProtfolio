...
export default function Home() {
    ...
    return (
        <div className="flex flex-col w-5/6 md:w-4/5 xl:w-2/3 items-left pt-20 md:pt-60 md:p-20 space-y-4 mb-20 md:mb-0 md:h-screen">
            ...
            <div className="flex justify-center items-center w-[50px] h-[50px] border rounded-full  animate-bounce-5px">
                <p className="dark:text-slate-200 text-lg text-center">↓</p>
            </div>
            {/* Look at npm react-curved-text for desired effect */}
        </div>
    );
}
