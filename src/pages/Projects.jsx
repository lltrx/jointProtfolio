    ...
    <div className="h-[1350px] lg:h-[1200px] md:pt-20 w-full mb-28 md:mb-72 lg:mb-0">
      ...
      {dark ? (
        ...
        <div className="mt-64 md:mt-72 lg:mt-44 mb-40 lg:mb-20 xl:mb-20">
          <h1 className="pt-24 md:pt-8 font-bold bg-gradient-to-br from-[#2779e3] to-[#1a5cb0] py-4 bg-clip-text text-center text-4xl font-display text-transparent md:text-7xl">
            Projects
          </h1>
          <NavLink
            to={`/archive`}
                ...
                <div className="p-4">
                  ...
                  <div className="mt-4 flex justify-between items-center">
                    <motion.button
                      ...
                      onClick={() => setActiveCard(null)}
                      className="px-4 py-2 rounded-xl bg-[#2779e3] text-white text-xs font-bold"
                    >
                      Close
                    </motion.button>
                    <motion.a
                  ...
                  {activeCardId !== project.id && (
                    ...
                    >
                      <CardContainer
                        ...
                        layoutId={`card-${project.id}-${id}`}
                      >
                        <CardBody className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-[#2779e3]/[0.25] dark:bg-zinc-950  w-auto sm:w-[30rem] h-auto rounded-xl p-6   ">
                          <CardItem
                            translateZ="50"
