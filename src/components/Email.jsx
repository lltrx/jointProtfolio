        ...
        <div className="w-[50px] hidden md:flex font-bold flex-col justify-center fixed bottom-5 right-5">
            {
                document.documentElement.classList.contains('noAnimation') ? (
                    <div>
                        <p style={{ color: color }} className={`text-center rotate-90 mb-60 tracking-wider hover:scale-105 transition duration-300 ease-in-out`}><a href="mailto:nathanhutchison02@gmail.com">nathanhutchison02@gmail.com</a></p>
