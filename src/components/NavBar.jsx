...
export default function NavBar() {
  ...
  return (
    <header
      className={`sticky top-0 w-full flex items-center justify-between z-40 px-4 h-20 shadow-md backdrop-filter backdrop-blur-sm bg-blue-50/50 dark:bg-zinc-900/90 transition duration-300 ease-in-out ${navbarStyle}`}
    >
      <NavLink to={"/"}>
      ...
      <div className="flex space-x-4 items-center justify-center">
        <div className="hidden md:flex space-x-4 items-center justify-center">
          <a
            href="/#home"
            className="text-[#3b88ed] dark:text-[#1a5cb0] font-display font-bold hover:text-[#1a5cb0] dark:hover:text-[#3b88ed] transition duration-300 ease-in-out relative group"
            onMouseEnter={handleMouseEnter}
            onMouseLeave={handleMouseLeave}
          >
            Home
            <span className="absolute bottom-0 h-[1px] bg-[#3b88ed] transition-all duration-300 ease-in-out pointer-events-none"></span>
          </a>
          <a
            href="/#about"
            className="text-[#3b88ed] dark:text-[#1a5cb0] font-display font-bold hover:text-[#1a5cb0] dark:hover:text-[#3b88ed] transition duration-300 ease-in-out relative group"
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-flex h-8 animate-shimmer items-center justify-center rounded-md border border-zinc-600 bg-[linear-gradient(110deg,#09090b,45%,#333,55%,#09090b)] bg-[length:200%_100%] px-6 font-medium text-zinc-300 transition-colors focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50"
        >
          My CV
        </a>
      </div>
